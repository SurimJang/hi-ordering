...
INSERT INTO "category"."category" (category_name, user_id)
VALUES
('소바', 1),
('가츠', 1),
('우동', 1),
...
INSERT INTO "menu"."menu" (menu_name, menu_price, qty, category_id)
VALUES
('소바', 8000, 1, 1),
('자루소바', 10000, 1, 1),
('소바 곱빼기', 9000, 1, 1),
...
('자루우동', 8000, 1, 3),
('냉우동 곱빼기', 9000, 1, 3),
('김치나베 치즈가츠우동', 10000, 1, 3),
('김치나베 치킨가츠우동', 10000, 1, 3),
('만두나베우동', 9000, 1, 3),
('불고기우동(순한맛)', 9000, 1, 3),
('눈꽃 명란크림우동', 12000, 1, 3),
('카라이(매운)우동', 8500, 1, 3),
('치킨가라아게 우동(국물없는 우동)', 9000, 1, 3),
('불고기우동(매운맛)', 9000, 1, 3),
('미니우동&돈가츠', 8000, 1, 4),
('미니우동&치즈가츠', 8000, 1, 4),
('미니우동&치킨가츠', 8000, 1, 4),
('이루다 소소한 세트(돈가츠)', 10000, 1, 5),
('이루다 오붓한 세트(돈가츠)', 12000, 1, 5),
('이루다 오붓한 세트(치킨가츠)', 12000, 1, 5),
('이루다 소소한 세트(치킨가츠)', 10000, 1, 5),
('자루우동 고명추가', 2000, 1, 6),
('계란후라이', 1000, 1, 6),
('소바 육수추가', 1000, 1, 6),
('수제팽이버섯 튀김', 2000, 1, 6),
